...
1. **Download the installer** (current release **v1.0.5**):
   - **Direct:** [Snipalot-1.0.5-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.5/Snipalot-1.0.5-setup.exe)
