...
**Current installer (latest):** [Snipalot-1.0.14-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.14/Snipalot-1.0.14-setup.exe) — see [Releases](https://github.com/Koprowski/snipalot/releases).
...
**[⬇ Download Snipalot-1.0.14-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.14/Snipalot-1.0.14-setup.exe)**

1. Click the link above to download the installer
2. Once downloaded, open your **Downloads** folder and double-click **Snipalot-1.0.14-setup.exe**
