...
**Latest installer:** [Download Snipalot-1.0.26-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.26/Snipalot-1.0.26-setup.exe)
...
1. **Download the installer** (current release **v1.0.26**):
   - **Direct:** [Snipalot-1.0.26-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.26/Snipalot-1.0.26-setup.exe)
