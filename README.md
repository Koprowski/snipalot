...
1. **Download the installer** (current release **v1.0.6**):
   - **Direct:** [Snipalot-1.0.6-setup.exe](https://github.com/Koprowski/snipalot/releases/download/v1.0.6/Snipalot-1.0.6-setup.exe)
